// src/pages/UrlsPage.ts - CRUD Operations Implementation

import type { PageComponent, DOMManager, UrlData } from '../types/app';
    ...
    const columns: TableColumn[] = [
      {
        ...
        title: 'Short Code',
        width: '200px',
        render: (value: string, record: UrlData) => `
      ...
      },
      {
        ...
        title: 'Status',
        width: '100px',
        render: (value: number | undefined, record: UrlData) => {
